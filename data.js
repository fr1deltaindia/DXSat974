const TESTS = [
 {date:"2026-09-17",sat:"RASCOM-QAF1R",pos:"2,9°E",beam:"Ku South",place:"La Réunion",band:"Ku",freq:"11231 H",sr:"40000",service:"26 services reçus ; 9 sans image au moment du test : RLPRO, Shalom Television, RTNC 3, PRO-TV, CUTV, SudFM TV, Resurrection TV, Elan TV, LiveHD TV",dish:"85 cm offset",measure:"Octagon : SNR 35 % / AGC 79 %. Blind/auto détectent le TP mais ne listent pas les services ; scan manuel = 26 services. Réception également confirmée avec le V5.",status:"Stable"},
...
const SATELLITES = [
 ...
 },
 {
   ...
   dx:"Réception terrain confirmée à La Réunion sur le faisceau Ku South avec une parabole offset de 85 cm. Le 17/09/2026, un scan manuel Octagon a trouvé 26 services sur 11231 H / 40000 (SNR 35 % / AGC 79 %), et le V5 a également confirmé la réception. Les listes publiques récentes donnent le même multiplex autour de 11230 V / 40000 DVB-S2 QPSK 3/4 ; la polarisation terrain est conservée telle qu'affichée par le récepteur.",
...
const NEWS = [
 {date:"2026-09-17",type:"Nouvelle réception DX",title:"RASCOM-QAF1R 2,9°E reçu à La Réunion avec 85 cm",text:"Réception confirmée sur 11231 / 40000 avec une parabole offset de 85 cm. Octagon : SNR 35 % / AGC 79 % et 26 services en scan manuel ; blind scan et scan automatique détectent le transpondeur mais ne listent pas les chaînes. Le V5 confirme également le bouquet. Neuf services étaient détectés/verrouillés mais sans image au moment du relevé.",source:"https://rascomstar.com/"},
...
const QUICK_POINTING = [
 {sat:"RASCOM-QAF1R",pos:"2,9°E",band:"Ku",freq:"11231 H 40000 (terrain)",beam:"Ku South — public : 11230 V 40000",dish:"85 cm offset — réception confirmée",lnb:"Ku universel — LO 9750/10600",difficulty:"DX",checked:"17/09/2026"},
...
const REUNION_MAP_POINTS = [
  {
    ...
    tests:[
      ...
      {sat:"RASCOM-QAF1R",pos:"2,9°E",freq:"11231 H 40000",service:"26 services reçus — 9 sans image au moment du test",dish:"85 cm offset",equipment:"Octagon SF8008 Supreme / V5",measure:"SNR 35 % / AGC 79 % — scan manuel Octagon ; réception confirmée V5",status:"Stable",date:"17/09/2026"},
